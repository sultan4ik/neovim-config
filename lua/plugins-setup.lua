-- Функция установки менеджера пакетов packer.vim, если он не установлен
...
return packer.startup(function(use)
    ...
    use('hrsh7th/cmp-buffer')                                           -- автодополнение данными из буфера
    use('hrsh7th/cmp-path')                                             -- автодополнение данными путей файлов

    use("L3MON4D3/LuaSnip")                                             -- движок для сниппетов
    use("saadparwaiz1/cmp_luasnip")                                     -- еще один источник для автозавершений 
    ...
    use("williamboman/mason-lspconfig.nvim")                            -- соединяет разрыв между mason и lspconfig
    use("neovim/nvim-lspconfig")                                        -- конфигурация LSP-сервера
    use("hrsh7th/cmp-nvim-lsp")                                         -- для автозаполнения
    use(
    {
